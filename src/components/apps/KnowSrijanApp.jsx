...
const Section = ({ title, icon: Icon, children, color }) => (
    <div className="mb-8 last:mb-0">
        ...
        <div className="pl-11 text-gray-400 leading-relaxed space-y-4">
            {children}
        </div>
    </div>
);
...
const KnowSrijanApp = () => {
    return (
        <div className="w-full h-full bg-[#0a0a0b] text-white overflow-y-auto custom-scrollbar">
            {/* Hero Header */}
            <div className="relative h-48 bg-gradient-to-br from-indigo-900 via-purple-900 to-black flex items-end p-8">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20" />
                <div className="relative z-10">
                    <h1 className="text-4xl font-extrabold text-white mb-2 tracking-tighter">
                        Know Srijan?
                    </h1>
                    <p className="text-indigo-300 font-medium">Software Engineer • Creator • Problem Solver</p>
                </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto p-8 md:p-12">
                ...
                <div className="mt-16 pt-8 border-t border-white/5 text-center text-gray-500 text-sm">
                    <p>© {new Date().getFullYear()} Srijan Chandra. Built with passion and code.</p>
                </div>
            </div>
        </div>
    );
